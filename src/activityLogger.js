...
export const ActivityLogger = {
  ...
  bordroEmployeeTerminate: (name, date) => logActivity('update', `Personel işten çıkarıldı: ${name} (Ayrılış: ${date})`, 'bordro'),
  bordroEmployeeReactivate: (name) => logActivity('update', `Personel yeniden aktif edildi: ${name}`, 'bordro'),
